        ...
        function generateInvoice() {
            ...
            // Update GST term
            const gstValue = grandTotal * 0.05;
            document.getElementById('gstClientName').textContent = clientName;
            document.getElementById('gstValue').textContent = formatIndianNumber(gstValue);
